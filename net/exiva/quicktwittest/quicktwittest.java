package net.exiva.quicktwittest;
...
public class quicktwittest extends Application implements Resources, Commands {
	...
	public quicktwittest() {
		...
		// Registrar.registerProvider("quicktwittest", this, 99);
	}
	...
	public void resume() {
		...
		// registerForLeftShoulderHeld("quickTwit", ipc , 99);
				Registrar.sendMessage("quickTwit", ipc, null);
	}
